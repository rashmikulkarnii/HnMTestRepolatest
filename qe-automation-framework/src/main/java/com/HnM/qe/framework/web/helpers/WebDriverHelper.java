...
public class WebDriverHelper {
	...
	public static final String USERNAME = "rashmiajay_5kxVhl";
	public static final String AUTOMATE_KEY = "qvr1pGPsjmbBzE3zhawq";
	...
	public RemoteWebDriver launchChromeBrowser(String driverfilePath) throws Throwable
	{
		...
		caps.setCapability("project", "HnM Commerce Site");
		caps.setCapability("build", "Build3");
		//caps.setCapability("name", "Home page");
